# quaid-scanner Report: /Users/karstenwade/Projects/AINative-Studio/src/openclaw-gateway

**Score:** 🔴 0.8/10 — CRITICAL risk
**Maturity:** sandbox | **Depth:** standard | **Duration:** 0.1s
**Scanned:** 2026-06-01T21:11:24.791Z
...
- **[dep-pinning-packages-1]** Loosely pinned dependency "ws": "^8.18.0" uses ^ prefix in dependencies *(Consider pinning "ws" to an exact version for reproducible builds)*
- **[dep-pinning-packages-2]** Loosely pinned dependency "typescript": "^5.0.0" uses ^ prefix in devDependencies *(Consider pinning "typescript" to an exact version for reproducible builds)*
...
- **[dep-pinning-packages-4]** Loosely pinned dependency "@types/ws": "^8.5.0" uses ^ prefix in devDependencies *(Consider pinning "@types/ws" to an exact version for reproducible builds)*
...
- **[AK-TOOL-DOCKER-README.md:15]** Assumed knowledge: "docker" command used without Docker listed as prerequisite
- **[AK-TOOL-NPM-README.md:19]** Assumed knowledge: "npm" command used without Node.js listed as prerequisite
- **[AK-TOOL-NPM-README.md:20]** Assumed knowledge: "npm" command used without Node.js listed as prerequisite
- **[AK-TOOL-NPM-README.md:21]** Assumed knowledge: "npm" command used without Node.js listed as prerequisite
- **[AK-ACRONYM-ACP-README.md:3]** Undefined acronym "ACP" may confuse newcomers
- **[AK-ACRONYM-SSE-README.md:3]** Undefined acronym "SSE" may confuse newcomers
- **[AK-ACRONYM-POST-README.md:7]** Undefined acronym "POST" may confuse newcomers
- **[AK-ACRONYM-GET-README.md:8]** Undefined acronym "GET" may confuse newcomers
...
- **[MEDIUM impact / low effort]** Consider pinning "ws" to an exact version for reproducible builds
- **[MEDIUM impact / low effort]** Increase scannerTimeout in configuration or check network connectivity
...
---
*quaid-scanner v0.1.2 | 2026-06-01T21:11:24.791Z*
*Commit: 0107baaa21c3b1e0aacb8cf287695453efba7600*